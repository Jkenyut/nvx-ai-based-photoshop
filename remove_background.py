...
def remove_transparan(inputan_gambar, gambar_transparan, lokasi):
    ...
    background_transparan = cv2.resize(
        background_transparan, (height_transparan + 500, widht_transparan + 500)
    )
    # Crop Tinggi dan Lebarnya dan warna
    background_transparan = background_transparan[
        :height_transparan, :widht_transparan, :
    ]
