        ...
        if file.filename == "":
            ...
            try:
                ...
                return render_template(
                    "download_filter.html",
                    value=filename,  # Value untuk nama file name (download file image)
                    ...
                    pixel=hasil_pixel,
                )  # pixel untuk menampilkan file name ke web (lokasi)
    ...
    if request.method == "POST":
        ...
        if file.filename == "":
            ...
            try:
                ...
                transparan = remove_transparan(
                    image_upload, image_transparan, lokasi_transparan
                )
                ...
                return render_template(
                    "download_remove.html",
                    value=filename,  # Value untuk nama file name (download file image)
                    transparan=hasil_remove_background_transparan,
                )  # transparan untuk menampilkan file name ke web (lokasi)
            except:
    ...
    if request.method == "POST":
        ...
        if file.filename == "":
            ...
            try:
                ...
                return render_template(
                    "download_smoothing.html",
                    value=filename,  # Value untuk nama file name (download file image)
                    smoothing=hasil_smoothing,
                )  # smoothing untuk menampilkan file name ke web (lokasi)
            except:
...
def download_file(filename):
    ...
    )  # send dari direktori 'statc/upload' + filename
